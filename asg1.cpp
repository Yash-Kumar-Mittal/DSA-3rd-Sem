...
int main()
{
    ...
    Add_Family_Member(Family_head,"GrandFather", 78);
    Add_Family_Member(Family_head, "GrandMother", 69);
    Add_Family_Member(Family_head, "Father", 43);
    Add_Family_Member(Family_head, "Mother", 39);
    Add_Family_Member(Family_head, "Brother", 2);
    Add_Family_Member(Family_head, "Me", 15);
