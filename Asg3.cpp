...
SOLUTION: We can search an element in an array whose size is unknown in O(logn) time complexity provided that the array is in sorted in increasing order .We can do this by making some modification in binary search technique.
